...
**Contents:**
- [Creating the Project Directory and Installing Packages](#creating-the-project-directory-and-installing-packages)
- [Constructing the 'app.js' File](#constructing-the-'app.js'-file)
- [Setting Up and Deploying the Database](#setting-up-and-deploying-the-database)
- [Routing the Application](#routing-the-application)
- [Rendering with PUG](#rendering-with-pug)
---------
